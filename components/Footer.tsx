...
const BonittoFooterLogo = ({ className = 'w-[135px] h-auto md:w-[251px]' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 331.27 72.1" fill="#fff" className={className} role="img" aria-label="Bonitto">
    <g>
...
const socialLinks = [
  { href: 'https://www.facebook.com/profile.php?id=61591763210416', icon: FacebookIcon, label: 'Facebook' },
  { href: 'https://www.instagram.com/bonitto_israel', icon: InstagramIcon, label: 'Instagram' },
];
      ...
      <div className="footer-company-info-wrapper">
        ...
        <div className="footer-powered">
          <Link
            ...
            aria-label="Bonitto"
          >
            <BonittoFooterLogo className="w-[135px] h-auto" />
          </Link>
        </div>
      </div>
    </section>
